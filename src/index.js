...
function generateQuote(event) {
  ...
  let context =
    "You are an inspiring AI that likes to share knowledge with others. Your mission is to generate a simple cite of maximum 3 lines in basic HTML adding a <br> after each line. Please make sure to follow the user instructions.Please sign at the end of the quote with <strong>SheCodes AI Athena</strong>. Please do not wrap the cite between quotes and do not write in italic";
